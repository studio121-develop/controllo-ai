...
export const chiamataReale = (url, init) => fetch(url, init);
function decodifica(buffer, tipo) {
...
export async function leggi(url, chiama = chiamataReale, tempoMs = TEMPO_MASSIMO_MS) {
...
export function origineDa(sito) {
...
export function sembraSfidaAntiBot(l) {
...
export function sembraInManutenzione(html) {
