...
export function controllaPagina(html, url, xRobots, home) {
    ...
    c.push(controllo("titolo", "La pagina ha un titolo chiaro", !t ? "male" : titoloDebole ? "male" : t.length < 15 || t.length > 70 ? "neutro" : "bene", !t ? "manca il titolo" : titoloDebole ? `«${t}»: dice solo il nome, non cosa fai` : `«${t}»${t.length > 70 ? " (lungo: Google lo taglia)" : t.length < 15 ? " (corto)" : ""}`, dove));
